...
#   new cluster_apicore = directors.round_robin();

#   cluster_apicore.add_backend(apicore);
# }
# acl purge {
#     "localhost";
#     "172.17.0.0/16";
...
#   set req.backend_hint = cluster_apicore.backend();
# }
vcl 4.0;
...
backend server1 { # Define one backend
  .host = "10.0.1.20";    # IP or Hostname of backend
